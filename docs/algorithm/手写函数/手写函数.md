...
## 8.手动实现一个instanceof {#8手动实现一个instanceof}
```js
...
## 10.基于Promise封装一个Ajax {#10基于promise封装一个ajax}
```js
